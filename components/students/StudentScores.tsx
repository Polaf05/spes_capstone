        ...
        <div className="grid grid-cols-4">
          ...
          <div className="col-span-2 flex justify-end">
            <p
              ...
              className="underline decoration-2 underline-offset-4 hover:cursor-pointer hover:text-ocean-400"
            >
              Go Back
            </p>
          </div>
        </div>
        <div className="grid grid-flow-row grid-cols-2 overflow-x-auto gap-4 mt-4 w-full">
          {task_array?.map(
            (task, idx) =>
              !task.status.match(/Passed|Perfect/g) && (
                <div
                  className={classNames(
                    "h-16 p-3 rounded-md flex justify-between col-span-1",
                    task.status === "Failed"
                      ? "bg-red-100"
                ...
                >
                  <div>
                    <p className="text-[0.7rem]">Task {task.tasked_number}:</p>
